    ...
    for i in range(1, morphology._numMaterial + 1):
        ...
        if (runquiet is not True) or ((outputmat is not None) and (i in outputmat)):
            ...
            if (runquiet is not True) or ("vfrac" in outputplot):
                ...
                ax1.set_title(f"Material {i} Vfrac")
            ...
            if runquiet is not True:
                ...
                ax3.set_title(f"Material {i} Vfrac")
                ax3.set_xlim(left=0)
            ...
            if (runquiet is not True) or ("theta" in outputplot):
                ...
                ax5.set_title(f"Material {i} theta")
            ...
            if (runquiet is not True) or ("psi" in outputplot):
                ...
                ax6.set_title(f"Material {i} psi")
            ...
            if runquiet is not True:
                ...
                ax7.set_title(f"Material {i} theta")
                ax7.set_xlim(left=0)
                ...
                ax8.set_title(f"Material {i} psi")
                ax8.set_xlim(left=0)
        ...
        if outputmat and (i in outputmat):
            ...
            if outputplot and ("vfrac" in outputplot):
                if outputaxes:
                    ...
                    fig_yt = rgb_return.shape[0] - ax1.get_window_extent().intervaly[
                        1
                    ].astype(int)
                    fig_yb = rgb_return.shape[0] - ax1.get_window_extent().intervaly[
                        0
                    ].astype(int)
            ...
            if outputplot and "S" in outputplot:
                if outputaxes:
                    ...
                    fig_yt = rgb_return.shape[0] - ax2.get_window_extent().intervaly[
                        1
                    ].astype(int)
                    fig_yb = rgb_return.shape[0] - ax2.get_window_extent().intervaly[
                        0
                    ].astype(int)
            ...
            if outputplot and "theta" in outputplot:
                if outputaxes:
                    ...
                    fig_yt = rgb_return.shape[0] - ax5.get_window_extent().intervaly[
                        1
                    ].astype(int)
                    fig_yb = rgb_return.shape[0] - ax5.get_window_extent().intervaly[
                        0
                    ].astype(int)
            ...
            if outputplot and "psi" in outputplot:
                if outputaxes:
                    ...
                    fig_yt = rgb_return.shape[0] - ax6.get_window_extent().intervaly[
                        1
                    ].astype(int)
                    fig_yb = rgb_return.shape[0] - ax6.get_window_extent().intervaly[
                        0
                    ].astype(int)
